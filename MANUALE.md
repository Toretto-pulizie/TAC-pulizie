...
- **"+ Aggiungi timbratura manuale"**: apre un modulo per inserire una sessione da zero (Collaboratore, Sede, Data, Inizio, Spostamento opzionale, Note) — per i casi in cui il collaboratore non abbia timbrato dall'app. Per l'orario di fine ci sono due modi, uno dei due basta: si scrive direttamente **Fine (se nota)**, oppure — se non si conosce l'orario preciso — si scrive quante **Ore lavorate** (es. "2:30" oppure "150") e la Fine si calcola da sola a partire dall'Inizio. Non ha coordinate GPS (colonna GPS vuota).

...
- Il modulo comprende: Cliente, Tipo di prestazione, Tipo di servizio, Ore, Spostamento, Interventi/settimana o mese, Ore/pass vetri, Tariffe, Condizioni di pagamento, Note (anche da frasi preimpostate). In fondo, sulla stessa riga: **Totale** (calcolato in automatico da ore/tariffe/frequenza, sola lettura — è il prezzo di listino), **Sconto %** (opzionale, calcola da solo il Netto a partire dal Totale), **Netto** (il prezzo scontato, se noto), **Adeguamento €** (importo facoltativo: se compilato, **sostituisce** il Netto come prezzo venduto finale — utile per mettere mano a mano al prezzo, es. arrotondamenti o accordi verbali). Esempio: Totale 200€, Sconto 10% → Netto 180€, ma inserendo Adeguamento 150€ il prezzo venduto finale diventa 150€. Lo sconto mostrato in elenco e in stampa riflette sempre Totale→Netto e non cambia con l'Adeguamento; il prezzo venduto mostrato ovunque (elenco, stampa, PDF, consuntivi) è l'Adeguamento se presente, altrimenti il Netto.

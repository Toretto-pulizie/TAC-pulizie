...
- **Aggiungi utente** / **Modifica utente**: Nome, Cognome, Telefono, Email, Password (o "Nuova password" in modifica, vuoto per non cambiarla), Ruolo (Collaboratore o Amministratore). La scheda "Modifica utente" mostra il proprio titolo nell'intestazione in alto (dove di solito compare "Utenti"), con accanto, a destra, "← Torna all'elenco".

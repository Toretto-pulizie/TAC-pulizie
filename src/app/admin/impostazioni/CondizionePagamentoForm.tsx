...
import { createCondizionePagamento } from "@/app/actions/condizioniPagamento";

export function CondizionePagamentoForm() {
  const [state, action, pending] = useActionState(createCondizionePagamento, undefined);

...
const ClientBaseSchema = {
  ...
  telefonoRiferimento: z.string().trim().optional(),
  emailRiferimento: z.string().trim().optional(),
  telefono: z.string().trim().optional(),
...
function clientFormFields(formData: FormData) {
  return {
    ...
    telefonoRiferimento: formData.get("telefonoRiferimento") || undefined,
    emailRiferimento: formData.get("emailRiferimento") || undefined,
    telefono: formData.get("telefono") || undefined,
...
export async function createClient(_prevState: unknown, formData: FormData) {
  ...
  const created = await prisma.client.create({
    data: {
      ...
      telefonoRiferimento: telefonoRiferimento || null,
      emailRiferimento: emailRiferimento || null,
      telefono: telefono || null,
      email: email || null,
      notes: notes || null,
    },
